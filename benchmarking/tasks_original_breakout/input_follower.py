...
# Define hardware.
input_pin = Digital_input('X1', rising_event='rising_edge', falling_event='falling_edge', debounce=False)
output_pin = Digital_output('X2')

if high_load:
    poisson_input_pin_1 = Digital_input('Y3', rising_event='poisson_rising_1', falling_event='poisson_falling_1', debounce=False)
    poisson_input_pin_2 = Digital_input('Y4', rising_event='poisson_rising_2', falling_event='poisson_falling_2', debounce=False)
