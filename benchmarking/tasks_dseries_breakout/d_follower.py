...
control_GC = True  # Determnies whether the time of garbage collection is controlled.

# Define hardware.
input_pin = Digital_input('W50', rising_event='rising_edge', falling_event='falling_edge', debounce=False)
output_pin = Digital_output('W46')

if high_load:
    poisson_input_pin_1 = Digital_input('W47', rising_event='poisson_rising_1', falling_event='poisson_falling_1', debounce=False)
    poisson_input_pin_2 = Digital_input('W49', rising_event='poisson_rising_2', falling_event='poisson_falling_2', debounce=False)
    analog_input_1 = Analog_input('W10', 'Analog1', 1000)
    analog_input_2 = Analog_input('W24', 'Analog2', 1000)
