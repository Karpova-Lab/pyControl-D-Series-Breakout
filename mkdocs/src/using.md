...
???+ warning
    ...
    The breakout board is designed to use the microcontroller's high speed USB interface. We must make a change to ``boot.py`` so that everything works properly [https://pybd.io/hw/pybd_sfxw.html#usb-ports](https://pybd.io/hw/pybd_sfxw.html#usb-ports).
